...
Semantic HTML provides meaning to the elements in your code.
...
It allows all members of the team to submit and track changes to the code over the course of the project.

5. Define mobile-first design in your own words.

Mobile first design is when you design for a mobile device, putting the necessary elements in place based on importance since you have smaller real estate to work with. Then, as you design for larger devices, you can expand on the content to include extras and more visual elements if you want.
